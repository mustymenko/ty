...
def get_named_entities(text):
    """Takes full text and returns iterator with found NER lines in it"""
    ners = []
...
class TYNamedEntityTestCase(unittest.TestCase):
    def test_ner_extraction(self):
        text = "When we went to Los Angeles last year we visited the Hollywood Sign"
        self.assertEqual({"Los Angeles", "Hollywood Sign"}, set(get_named_entities(text)))
